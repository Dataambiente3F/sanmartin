...
if (typeof crearCapaGanadores === 'function') {
  ...
  window.generalnacional23Layer = crearCapaGanadores(2023, 'GENERAL', 'PRESIDENTE Y VICE', 'generalnacional23Layer', 'ganador');
  window.segundavueltanacional23Layer = crearCapaGanadores(2023, 'SEGUNDA VUELTA', 'PRESIDENTE Y VICE', 'segundavueltanacional23Layer', 'ganador');
