  ...
  document.addEventListener('click', () => {
    ...
    window.map = new ol.Map({ // Añade 'window.'
        ...
        layers: [
            ...
            puntoscriticosLayer, contenedoresLayer, censoalumbradoLayer, totem3FLayer, generales2023Layer
...
eleccionesToggles = [
    setupLayerToggleWithEye(
        ...
        'generales2023Icon',
        generales2023Layer,  // Capa global creada en capasEstilos.js
...
map.addLayer(generales2023Layer);
